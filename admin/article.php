    ...
    <div class="row">
        <div class="col col-md-8 mx-auto">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <a href="edit-article.php?id=<?= $article[0]['id']; ?>" class="btn btn-sm btn-outline-info"><i
                            class="fa-solid fa-pen-to-square"></i></a>
                    <a href="edit-article-image.php?id=<?= $article[0]['id'] ?>" class="btn btn-sm btn-outline-dark"><i
                            class="fa-solid fa-images"></i></a>
                    <button data-bs-toggle="modal" data-bs-target="#myModal" class="btn btn-sm btn-outline-danger"><i
                ...
                <div>
                    ...
                    <a href="edit-article-image.php?id=<?= $article[0]['id'] ?>" class="btn btn-sm btn-outline-dark"><i
                            class="fa-solid fa-images  me-1"></i>Edit Image</a>
                    <button data-bs-toggle="modal" data-bs-target="#myModal" class="btn btn-sm btn-outline-danger"><i
